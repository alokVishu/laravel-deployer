  ...
  <div class="flex min-h-screen">
    ...
    <div class="basis-full lg:basis-1/3 bg-card">
      <div class="min-h-screen flex flex-col pt-14">
        <div class="flex justify-self-start gap-2 grow w-4/5 md:w-1/2 lg:w-4/5 mx-auto">
          @svg('tabler-chevron-left', 'w-6 h-6')
          <a href="{{ url('/') }}">Back to the website</a>
        </div>

        <div class="w-4/5 md:w-1/2 lg:w-4/5 mx-auto justify-self-center grow">
          <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
            ...
            <div class="mb-[77px] flex items-center gap-2">
              @svg('tabler-chevron-left', 'w-6 h-6')
              <a href="{{ url('/') }}">{{ __('Back to the website') }}</a>
            </div>
            ...
            <div class="mb-0">
              <div>
                ...
                <div class="text-center my-4 flex flex-wrap justify-center gap-2">
                  ...
                  <button type="submit" class="text-primary-500 whitespace-nowrap">{{ __('Resend') }}</button>
                </div>
              </div>
            </div>
          </form>
